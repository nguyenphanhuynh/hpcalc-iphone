...
#define K_P_Y_X			K_F, K_1
#define K_TO_HMS		K_F, K_2
#define K_TO_RAD		K_F, K_3
#define K_X_NE_Y		K_F, K_MINUS
...
#define K_C_Y_X			K_G, K_1
#define K_TO_H			K_G, K_2
#define K_TO_DEG		K_G, K_3
#define K_X_NE_0		K_G, K_MINUS
...
#define K_X_EXCH_PAREN_I	K_F, K_SIN
#define K_PAREN_I		K_F, K_COS
#define K_I				K_F, K_TAN
#define K_TO_R			K_F, K_EEX
#define K_X_EXCH_I		K_F, K_4
#define K_DSE			K_F, K_5
#define K_ISG			K_F, K_6
#define K_X_GT_Y		K_F, K_MULT
...
#define K_TO_P			K_G, K_EEX
#define K_SF			K_G, K_4
#define K_CF			K_G, K_5
#define K_F_TEST		K_G, K_6
#define K_X_GT_0		K_G, K_MULT
