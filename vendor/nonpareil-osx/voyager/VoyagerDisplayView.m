...
- (id)initWithFrame:(NSRect)frameRect
{
	...
	if ((self = [super initWithFrame:frameRect]) != nil)
	{
		...
		if ((font = [NSFont fontWithName:@"Monaco" size:9.0]) != nil)
...
#define ANNUNC_OFF 5.0
	if (((ds[1] >> 17) & 1))
		[[NSString stringWithCString: "*"] drawAtPoint: NSMakePoint(15.0,ANNUNC_OFF)
											 withAttributes: attrs];
	if (((ds[2] >> 17) & 1))
		[[NSString stringWithCString: "USER"] drawAtPoint: NSMakePoint(47.0,ANNUNC_OFF)
										withAttributes: attrs];
	if (((ds[3] >> 17) & 1))
		[[NSString stringWithCString: "f"] drawAtPoint: NSMakePoint(89.0,ANNUNC_OFF)
										   withAttributes: attrs];
	if (((ds[4] >> 17) & 1))
		[[NSString stringWithCString: "g"] drawAtPoint: NSMakePoint(107.0,ANNUNC_OFF)
										withAttributes: attrs];
	if (((ds[5] >> 17) & 1))
		[[NSString stringWithCString: "BEGIN"] drawAtPoint: NSMakePoint(125.0,ANNUNC_OFF)
										withAttributes: attrs];
	if (((ds[6] >> 17) & 1))
		[[NSString stringWithCString: "G"] drawAtPoint: NSMakePoint(183.0,ANNUNC_OFF)
										  withAttributes: attrs];
	if (((ds[7] >> 17) & 1))
		[[NSString stringWithCString: "RAD"] drawAtPoint: NSMakePoint(189.0,ANNUNC_OFF)
											withAttributes: attrs];
	if (((ds[8] >> 17) & 1))
		[[NSString stringWithCString: "D.MY"] drawAtPoint: NSMakePoint(212.0,ANNUNC_OFF)
										   withAttributes: attrs];
	if (((ds[9] >> 17) & 1))
		[[NSString stringWithCString: "C"] drawAtPoint: NSMakePoint(246.0,ANNUNC_OFF)
										   withAttributes: attrs];
	if (((ds[10] >> 17) & 1))
		[[NSString stringWithCString: "PRGM"] drawAtPoint: NSMakePoint(273.0,ANNUNC_OFF)
										withAttributes: attrs];
